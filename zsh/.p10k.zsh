# Generated by Powerlevel10k configuration wizard on 2024-04-14 at 00:01 MDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND='#17FDA2'
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND='#1E1E2E'
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND='#17FDA2'
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND='#1E1E2E'
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND='#17FDA2'
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND='#1E1E2E'
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND='#17FDA2'
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_FOREGROUND='#1E1E2E'
  typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND='#17FDA2'
  typeset -g POWERLEVEL9K_VCS_LOADING_FOREGROUND='#1E1E2E'
  ...
  function my_git_formatter() {
    ...
    local       meta='%F{#1E1E2E}' # dark grey foreground
    local      clean='%F{#1E1E2E}' # dark grey foreground
    local   modified='%F{#1E1E2E}' # dark grey foreground
    local untracked='%F{#1E1E2E}' # dark grey foreground
    local conflicted='%F{#1E1E2E}' # dark grey foreground
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND='#fff'
  ...
  #########################[ proxy: system-wide http/https/ftp proxy ]##########################
  # Proxy color.
  typeset -g POWERLEVEL9K_PROXY_FOREGROUND='#fff'
  typeset -g POWERLEVEL9K_PROXY_BACKGROUND='#1E1E2E'
  # Custom icon.
